...
(function () {
    ...
    var aMod_definer = function( theM_firsttorun, theM_exiter) {
        ...
        var ModulePackages = "pathsloader-all-test";
        ...
        var pgInitWithModuleConstants = function( theToInit) {
            ...
            theToInit.PATHSLOADERTESTTITLE = "pathsloader-all-test";
        ...
        aModule.ModuleFullName = ModuleFullName;
            ...
            var pPathsLoaderAllTest = function( theCallback) {
                    ...
                    function( theError) {
                        ...
                        aM_pathsloader_async_test.pPathsLoaderTest_async(
                            function( theError) {
                                ...
                                var aM_cmpandtestspathsloader_test = require('./cmpandtestspathsloader-test');
                                if( !aM_cmpandtestspathsloader_test) {
                                    var anErrorReport = ',{ "ERROR require ./cmpandtestspathsloader-test" }';
                                    console.log( anErrorReport);
                                ...
                                aM_cmpandtestspathsloader_test.pCmpAndTestsPathsLoaderTest(
                                    function( theError) {
                                        if( theError) {
                                            theCallback( theError);
                                            return;
            ...
            if( pPathsLoaderAllTest){}/* CQT */
            aModule.pPathsLoaderAllTest = pPathsLoaderAllTest;
            ...
            if( theM_firsttorun.fIsFirstToRun()) {
                (function() {
                    ...
                    aModule.pPathsLoaderAllTest( aCallback);
                })()
            }

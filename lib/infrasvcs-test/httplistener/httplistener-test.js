...
(function () {
    ...
    var aMod_definer = function( theM_httplistenergenerictest,
        ...
        var aHttpListenerTest_Prototype = (function() {
            ...
            var _pInit = function( theTitle, theRequestSpecsPath) {
                ...
                this._pInit_HttpListener( theTitle, theRequestSpecsPath);
            };
            if( _pInit){}/* CQT */
            ...
            var _pInit_HttpListener = function( theTitle, theRequestSpecsPath) {
            ...
            var fCreateServer = function( thePort) {
                ...
                var aServer = new theM_httplistener.HttpListener_Constructor( "ForHttpListener-" + aTitle, thePort);
                if( !aServer){
                    return null;
                }
            ...
            var pS_RequestTest = function( theCallback) {
                ...
                this._v_RequestTest = new theM_httprequest.HttpRequestTest_Constructor( "RequestTestFor-" + aTitle, this._v_RequestSpecs);
            ...
            var pF_HttpListener = function( theCallback) {
                this.pF_HttpListenerGenericTest( theCallback);
            };
            if( pF_HttpListener){}/* CQT */
            aPrototype.pF_HttpListener = pF_HttpListener;
            ...
            var pF_HttpListenerTest = function( theCallback) {
                ...
                this.pF_HttpListener( theCallback);
            };
        ...
        var HttpListenerTest_Constructor = function( theTitle, theLaunchtopSpecsOrPath) {
            ...
            this._pInit_HttpListener( theTitle, theLaunchtopSpecsOrPath);
        };
        HttpListenerTest_Constructor.prototype = aHttpListenerTest_Prototype;





        var HttpListenerTest_SuperPrototypeConstructor = function() {

            /* Keep handy reference to super-prototype for super method invocation */
            this._v_SuperPrototype = theM_httplistenergenerictest.HttpListenerGenericTest_Prototype;

            this._v_Prototype = aHttpListenerTest_Prototype;
            this._v_Type = null;
            this._v_Module    = null;
        };
        HttpListenerTest_SuperPrototypeConstructor.prototype = aHttpListenerTest_Prototype;
        ...
        var aModule = {
            "HttpListenerTest_Prototype": aHttpListenerTest_Prototype,
            "HttpListenerTest_Constructor": HttpListenerTest_Constructor,
            "HttpListenerTest_SuperPrototypeConstructor": HttpListenerTest_SuperPrototypeConstructor
        };
        ...
        aHttpListenerTest_Prototype._v_Module = aModule;
    ...
    if (typeof module !== 'undefined' && module.exports) {
        module.exports = (function() {
            ...
            var aM_httprequest              = require('../httprequest/httprequest-test');

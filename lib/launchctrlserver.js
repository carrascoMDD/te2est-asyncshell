...
(function() {
    ...
    var aMod_definer = function( theM_launcherctrlserver,
                                 theM_commandline) {

        var ModuleName     = "launchctrlserver";
        ...
        return theM_launcherctrlserver.fDefineLauncherCtrlServer_andRunIfFirst( aTestName, aTestSpec);
    ...
    if (typeof module !== 'undefined' && module.exports) {
        module.exports = (function() {
            ...
            var aM_launcherctrlserver  = require('./common-test/launchers/launcher-ctrlserver');
            var aM_commandline         = require('./infrasvcs/commandline/commandline');

            return aMod_definer( aM_launcherctrlserver, aM_commandline);
        })();
    }
    // AMD / RequireJS
    else if (typeof define !== 'undefined' && define.amd) {
        define([
            "./common-test/launchers/launcher-ctrlserver",
            "./infrasvcs/commandline/commandline"
        ], function (
            theM_launcherctrlserver,
            theM_commandline
        ) {
            return aMod_definer(
                theM_launcherctrlserver,

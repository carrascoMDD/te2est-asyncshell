...
(function () {
    ...
    var aMod_definer = function( theM_sentinels,
        ...
        var aMinServerTest_Prototype = (function() {
            ...
            aPrototype._v_Type = "MinServerTest";
            ...
            var _pInit = function( theTitle, theRequestSpecsPath) {
                ...
                this._pInit_MinServerTest( theTitle, theRequestSpecsPath);
            };
            if( _pInit){}/* CQT */
            ...
            var _pInit_MinServerTest = function( theTitle, theRequestSpecsPath) {
            ...
            if( _pInit_MinServerTest){}/* CQT */
            aPrototype._pInit_MinServerTest = _pInit_MinServerTest;
            ...
            var pS_SetupServer = function( theCallback) {
                ...
                if( this._v_Identifier) {
                    anIdentifierId = this._v_Identifier.fReserveId();
                }
                ...
                var anIdentifier = new theM_identifier.CtrlIdentifier_Constructor( "Identifier-For-" + aTitle, anIdentifierId);
                var aRecorder    = new theM_recorder.CtrlRecorder_Constructor(     "Recorder-For-"   + aTitle, anIdentifier);


                this._v_CtrlServer = new theM_minserver.MinServer_Constructor( "CtrlServer-For-" + aTitle, anIdentifier, aRecorder);
            ...
            var pS_RegisterRoutes = function( theCallback) {
                ...
                var aCtrlListener = this._v_CtrlServer.fCtrlListener();
                if( !aCtrlListener) {
                    theCallback( "pS_RegisterRoutes !this._v_CtrlServer.fCtrlListener()");
                    return;
                }
                ...
                for( var aRequestSpecIdx=0; aRequestSpecIdx < aNumRequestSpecs; aRequestSpecIdx++) {
                    ...
                    if( aRequestSpec) {
                        ...
                        var aHandlerFunction = this.fMinServerHandlerForRequestSpec( aRequestSpec);
                        if( aHandlerFunction) {

                            var aRegisterResult = false;

                            var aMethod = aRequestSpec[ "method"];
                            if( aMethod.toUpperCase() == this.METHOD_GET) {
                                aRegisterResult = aCtrlListener.fAddRoute_Get( aPort, aRoute, aHandlerFunction);
                            }
                            else {
                                if( aMethod.toUpperCase() == this.METHOD_POST) {
                                    aRegisterResult = aCtrlListener.fAddRoute_Post( aPort, aRoute, aHandlerFunction);
                                }
                            }

                            if( aRegisterResult) {
                                this._v_RegisteredRequestSpecs.push( aRequestSpec);
                            }
                        }
                    }
                }
            ...
            var fMinServerHandlerForRequestSpec = function( theRequestSpec) {
                ...
                var aHandler = function( theRequest, theResponse) {
                    ...
                    if( aThis.LOGHANDLES) {
                        ...
                        console.log( "fMinServerHandlerForRequestSpec Port=" + aPort + " Handled " + aRequestSpecStr.slice( 0, aThis.MAXREQUESTSPECSTRINGLEN));
                    }
                    ...
                    if( aThis.LOGHANDLES) {
                        ...
                        console.log( "fMinServerHandlerForRequestSpec_anymethod Responded " + aToRespondStr.slice( 0, aThis.MAXREQUESTSPECSTRINGLEN));
                    }
            ...
            if( fMinServerHandlerForRequestSpec){}/* CQT */
            aPrototype.fMinServerHandlerForRequestSpec = fMinServerHandlerForRequestSpec;
            ...
            var fOverallMinServerCallback = function( theCallback) {
            ...
            if( fOverallMinServerCallback){}/* CQT */
            aPrototype.fOverallMinServerCallback = fOverallMinServerCallback;
            ...
            var pF_MinServerTest = function( theCallback) {
                ...
                try {
                    ...
                    var aCallback = this.fOverallMinServerCallback( theCallback);
                    if( !aCallback) {
            ...
            if( pF_MinServerTest){}/* CQT */
            aPrototype.pF_MinServerTest = pF_MinServerTest;
        ...
        var MinServerTest_Constructor = function( theTitle, theRequestSpecsOrPath) {
            ...
            this._pInit_MinServerTest( theTitle, theRequestSpecsOrPath);
        };
        MinServerTest_Constructor.prototype = aMinServerTest_Prototype;




        var MinServerTest_SuperPrototypeConstructor = function() {

            this._v_Prototype = aMinServerTest_Prototype;
            this._v_Type = null;
            this._v_Module    = null;
        ...
        MinServerTest_SuperPrototypeConstructor.prototype = aMinServerTest_Prototype;
        ...
        var aModule = {
            "MinServerTest_Prototype": aMinServerTest_Prototype,
            "MinServerTest_Constructor": MinServerTest_Constructor,
            "MinServerTest_SuperPrototypeConstructor": MinServerTest_SuperPrototypeConstructor
        };
        ...
        aMinServerTest_Prototype._v_Module = aModule;
    ...
    if (typeof module !== 'undefined' && module.exports) {
        module.exports = (function() {
            ...
            var aM_minserver        = require('../ctrlserver/server-ctrl/minserver');
    ...
    // AMD / RequireJS
        ...
        define([
            ...
            "../ctrlserver/server-ctrl/minserver",

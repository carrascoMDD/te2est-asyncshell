...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-12-housekeeping launch-01-pregrowmemory launch-01-pregrowmemory-100mb-10mb samplelaunchtogether-41-housekeeping-pregrowmemory-thrashing-100mb-5secs-10mb-1milli-15mb.sh\033[0m"},'

...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-12-housekeeping launch-00-fakememorysnapshots samplelaunchtogether-42-housekeeping-fakememorysnapshots-thrashing-singleextrattempt-millisignore-heapusedover.sh\033[0m"},'

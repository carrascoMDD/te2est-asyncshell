...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-12-housekeeping launch-00-fakememorysnapshots samplelaunchtogether-48-housekeeping-fakememorysnapshots-thrashing-testspayloads-millisunder-heapusedover.sh\033[0m"},'

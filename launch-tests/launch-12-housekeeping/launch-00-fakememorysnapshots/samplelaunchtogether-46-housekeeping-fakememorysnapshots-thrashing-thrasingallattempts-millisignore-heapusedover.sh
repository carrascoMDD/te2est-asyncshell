...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-12-housekeeping launch-00-fakememorysnapshots samplelaunchtogether-46-housekeeping-fakememorysnapshots-thrashing-thrasingallattempts-millisignore-heapusedover.sh\033[0m"},'

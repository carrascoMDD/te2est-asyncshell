...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-12-housekeeping launch-00-fakememorysnapshots samplelaunchtogether-21-housekeeping-fakememorysnapshots-expectfailure-action-parameters-howmuchtoclean-minmax.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else

...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-12-housekeeping launch-00-fakememorysnapshots samplelaunchtogether-28-housekeeping-fakememorysnapshots-expectfailure-missingattempt.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else

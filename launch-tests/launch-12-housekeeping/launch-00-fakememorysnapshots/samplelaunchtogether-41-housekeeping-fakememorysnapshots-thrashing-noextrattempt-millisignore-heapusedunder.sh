...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-12-housekeeping launch-00-fakememorysnapshots samplelaunchtogether-41-housekeeping-fakememorysnapshots-thrashing-noextrattempt-millisignore-heapusedunder.sh\033[0m"},'

...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-12-housekeeping launch-00-fakememorysnapshots samplelaunchtogether-50-housekeeping-fakememorysnapshots-thrashing-all-millisunder-heapusedover.sh\033[0m"},'

...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-05-common launch-05-requestcached samplelaunchone-14-requestcached-cachehit-1MB.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else

...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-05-common launch-04-memory samplelaunchone-24-memory-report-ifmaxheapused-garbage-report.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else

...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-05-common launch-03-requestreply samplelaunchone-22-requestreply-releasepayloads-50MB.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else

...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-11-cleanup launch-10-cleanup-echo samplelaunchone-01-cleanup-echo-single-testcleanupall.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else

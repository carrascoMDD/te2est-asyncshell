...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-11-releasing launch-10-releasing-echo samplelaunchone-21-releasing-echo-single-testreleasingfile.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else

...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-11-releasing launch-10-releasing-echo samplelaunchone-01-releasing-echo-single-testreleasingall.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else

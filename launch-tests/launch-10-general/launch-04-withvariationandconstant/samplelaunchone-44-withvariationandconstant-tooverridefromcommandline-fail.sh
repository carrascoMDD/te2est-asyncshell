...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-10-general launch-04-withvariationandconstant samplelaunchone-44-withvariationandconstant-tooverridefromcommandline-fail.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else

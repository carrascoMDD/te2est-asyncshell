...
(function () {
    var aMod_definer = function() {
        ...
        var ModuleName     = "overrides_logpassed.js";
        ...
        var Settings = {
            ...
            "common-test": {
                ...
                "recorded-test": {
                    ...
                    EVENTSSETNOTFORCONSOLE: "EVENTKINDS_NOTFORCONSOLE_RESTRICTIVE",
                ...
                "resloader": {
                    ...
                    "resloader": {
                        ...
                        RESEVTSSETNOTFORCONSOLE : "RESEVTKINDS_NOTFORCONSOLE_RESTRICTIVE"
                    },
                ...
                "xloader": {
                    "xloader": {
                        ...
                        XLOEVESSETNOTFORCONSOLE: "XLOEVEKINDS_NOTFORCONSOLE_RESTRICTIVE"
                    }
                }
            },
            ...
            "infrasvcs-test": {
                "httprequest": {
                    "httprequest-generic-test": {
                        XXXURLHOSTREPLACEMENT: "localhost",
                        YYYURLHOSTREPLACEMENT: "192.168.69.82",
                        URLHOSTREPLACEMENT: "192.168.69.111",
            ...
            "ttst": {
                ...
                "ttst-test": {
                    ...
                    EVTSSETNOTFORCONSOLE : "EVTKINDS_NOTFORCONSOLE_RESTRICTIVE"
                },
            ...
            "browser-test": {
                "protractor-test": {
                    PROTRACTOR_HITPOINT:           "http://192.168.69.111:64404/springnut",
                    XXXPROTRACTOR_SELENIUMADDRESS: "http://localhost:4444/wd/hub",
                    PROTRACTOR_SELENIUMADDRESS:    "http://192.168.69.102:4444/wd/hub",
                    XXXPROTRACTOR_HITPOINT:        "http://localhost:8080/springnut",
                    RRRPROTRACTOR_HITPOINT:           "http://www.SpringNut.org/springnut",
                    ZZZPROTRACTOR_HITPOINT:        "http://192.168.69.82:8080/springnut",
